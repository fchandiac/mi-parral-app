...
import { serviceImage, findOneService } from '@/app/actions/services-actions';
      ...
      <Box sx={{ position: 'relative', zIndex: 2, height: '100%' }}>
        <Box
          sx={{
            ...
            height: '90%', // O ajusta la altura según sea necesario
            ...
            >
              ...
              <Typography
                ...
                sx={{
                  ...
                  textShadow: '1px 1px 2px rgba(0, 0, 0, 0.6)', // Agrega sombra al texto
